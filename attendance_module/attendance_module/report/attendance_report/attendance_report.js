...
frappe.query_reports["Attendance Report"] = {
	"filters": [
		...
		},
		{
			...
			"options": ["Late Arrival", "Early Leavers", "Check In/Out Missing" , "Pending Leaves", "Approved Leaves"],
			// "options": ["Late Arrival", "Early Leavers", "Check In/Out Missing" ,"Pending Attendance Requests", "Pending Leaves", "Approved Leaves"],
