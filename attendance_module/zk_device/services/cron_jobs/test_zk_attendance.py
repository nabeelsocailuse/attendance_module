...
# bench --site erp.alkhidmat.org execute akf_hrms.services.cron_jobs.test_zk_attendance.del_attendance
def del_attendance():
	...
	res = frappe.db.sql('''delete from `tabAttendance Log` 
			...
			''', as_dict=1)
	# print(res)
# bench --site erp.alkhidmat.org execute akf_hrms.services.cron_jobs.test_zk_attendance.get_zk_attendance
def get_zk_attendance():
	...
	emp_code = "886"
	start_time = f"2025-08-15 00:00:00"
	end_time = f"2025-08-15 23:59:59"
	# end_time = get_datetime()
	# start_time = add_to_date(end_time, hours=0, minutes=10)
